...
const WIKI_ARTICLES: Record<string, string> = {
    ...
    'バンクーバー': 'スタンレーパーク',
    'イエローナイフ（オーロラ）': 'オーロラ',
    'バンフ・ジャスパー（カナディアンロッキー）': 'モレーン湖',
    'バンクーバー＋バンフ': 'モレーン湖',
    'カッパドキア': 'カッパドキア',
    'イスタンブール': 'アヤソフィア',
    'トルコ大周遊（イスタンブール＋カッパドキア）': 'カッパドキア',
    '西安・兵馬俑': '兵馬俑',
    '中国三都＋西安': '兵馬俑',
    'ハルシュタット': 'ハルシュタット',
    'ウィーン＋ハルシュタット': 'ハルシュタット',
    '南仏（ニース・モナコ）': 'モンテカルロ',
    'パリ＋南仏': 'エッフェル塔',
    'チンクエテッレ': 'チンクエ・テッレ',
    'イタリア＋チンクエテッレ': 'チンクエ・テッレ',
    'トロムソ（北欧オーロラ）': 'オーロラ',
    'ドロミテ': 'トレ・チーメ・ディ・ラヴァレード',
    'マラケシュ・サハラ': 'ジャマ・エル・フナ広場',
    'モロッコ大周遊（マラケシュ＋シャウエン）': 'ジャマ・エル・フナ広場',
    'ルアンパバーン': 'ルアンパバーン',
    'フィジー': 'フィジー',
    'パラオ': 'パラオ',
    'ヨセミテ国立公園': 'ヨセミテ国立公園',
    'イエローストーン': 'イエローストーン国立公園',
    'サンフランシスコ＋ヨセミテ': 'ヨセミテ国立公園',
}
...
const JA_TO_EN: Record<string, string> = {
    ...
    'フィジー': 'Fiji',
    'ロックアイランド・南ラグーン': 'Rock Islands Southern Lagoon',
